...
\begin{document}
	...
	\section{Technical Description}
		...
		\subsection{Test Plan}
			...
			\\
			\begin{tabular}{|p{0.3\textwidth}|p{0.4\textwidth}|p{0.1\textwidth}|p{0.2\textwidth}|}
				\hline
				\rowcolor{gray!30}
				\textbf{Task} & 
	...
	\section{Appendix}
		...
		\label{subsec:appendixB}
			\begin{center}
				...
				\fbox{\includegraphics[width=\textwidth]{Figure7.jpg}}
			  	...
			  	\label{fig:figure7}
				\vspace{10pt}
				\fbox{\includegraphics[width=\textwidth]{Figure8.jpg}}
			  	\captionof{figure}{Profile Page in the Login State}
			  	\label{fig:figure8}
				\vspace{10pt}
				\fbox{\includegraphics[width=\textwidth]{Figure9.jpg}}
		...
		\label{subsec:appendixC}
			\begin{center}
			  	\fbox{\includegraphics[width=\textwidth]{Figure10.jpg}}
			  	\captionof{figure}{An earlier version of the MoviePage}
			  	\label{fig:figure10}
			  	\vspace{10pt}
			  	\fbox{\includegraphics[width=\textwidth]{Figure11.jpg}}
			  	\captionof{figure}{An experimental version of the MoviesPage}
			  	\label{fig:figure11}
			  	\vspace{10pt}
			  	\fbox{\includegraphics[width=\textwidth]{Figure12.jpg}}
		...
		\label{subsec:appendixD}
			\begin{center}
			  	\fbox{\includegraphics[width=\textwidth]{Figure13.jpg}}
			  	\captionof{figure}{Test 1 - Search by Title}
			  	\label{fig:figure13}
				\vspace{10pt}
				\fbox{\includegraphics[width=\textwidth]{Figure14.jpg}}
			  	\captionof{figure}{Test 2 - Search by Year}
			  	\label{fig:figure14}
				\vspace{10pt}
				\fbox{\includegraphics[width=\textwidth]{Figure15.jpg}}
			  	\captionof{figure}{Test 3 - Search by Title and Year}
			  	\label{fig:figure15}
				\vspace{10pt}
				\fbox{\includegraphics[width=\textwidth]{Figure16.jpg}}
			  	\captionof{figure}{Test 4 - Click on a Movie}
			  	\label{fig:figure16}
				\vspace{10pt}
				\fbox{\includegraphics[width=\textwidth]{Figure17.jpg}}
