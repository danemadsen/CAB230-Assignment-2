			...
			\subsection{How to Search for a Movie}
				\begin{enumerate}
					\item To search for a movie, click on one of the search boxes and start typing.\\\\
						\fbox{\includegraphics[width=\textwidth]{figures/Figure25.jpg}}
					\item A list of Movies will appear, click on the one you want to view.\\\\
						\fbox{\includegraphics[width=\textwidth]{figures/Figure26.jpg}}
			...
			\subsection{How to Visit a Cast Members Page}
				\begin{enumerate}
					\item To visit a cast members page, click on one of the cast members names on a Movie Page.\\\\
						\fbox{\includegraphics[width=\textwidth]{figures/Figure35.jpg}}
			...
			\subsection{How to Register an Account}
				\begin{enumerate}
					\item To register an account, first proceed to the profile page by clicking on the button at 
						...
						\fbox{\includegraphics[width=\textwidth]{figures/Figure28.jpg}}
					\item When the profile page first launches the page will be in the Login state, 
						...
						\fbox{\includegraphics[width=\textwidth]{figures/Figure29.jpg}}\newpage
					\item In the Register state enter your Email and then your desired password twice before clicking 
						...
						\fbox{\includegraphics[width=\textwidth]{figures/Figure30.jpg}}
			...
			\subsection{How to Login as a User}
				\begin{enumerate}
					...
					\item When the profile page launches, enter your Email and Password before clicking Login 
						...
						\fbox{\includegraphics[width=\textwidth]{figures/Figure33.jpg}}\newpage
			...
			\subsection{How to Logout}
				\begin{enumerate}
					...
					\item When the profile page launches, click on the Logout button to logout.\\\\
						\fbox{\includegraphics[width=\textwidth]{figures/Figure36.jpg}}\newpage
